    ...
    <>
      ...
      {sessao.tipo === "gestor" && (
        <ManagerDashboard
          ...
          professores={professores.map((p: any) => ({ id: p.id, nome: p.nome, cpf: p.cpf, email: p.email, telefone: p.telefone, login: p.login, modalidade: p.modalidade, percentualComissao: p.percentualComissao, photoUrl: p.photoUrl ?? undefined, cor: p.cor ?? "#1565C0" }))}
