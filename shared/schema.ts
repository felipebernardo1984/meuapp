...
export const conferenciaRegistros = pgTable("conferencia_registros", {
  ...
  percentualArena: text("percentual_arena").default("100"),
  percentualDestinatario: text("percentual_destinatario").default("0"),
  valorDestinatario: text("valor_destinatario").default("0"),
...
export const conferenciaGestores = pgTable("conferencia_gestores", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  arenaId: text("arena_id").notNull(),
  nome: text("nome").notNull(),
  percentualComissao: text("percentual_comissao").default("0"),
